...
const RedBus = ({ navigation }) => {
    ...
    const images = [{
        ...
        props: {
          source: require('../../media/RedBusMap.png')
        }
      }];
  return (
    ...
    <ImageBackground source={require('../../media/background.jpg')} style={styles.container}>
        ...
        <View style={styles.centeredContainer}>
            ...
            >
                <Text style={styles.topicbus}>{menuItems[0].label}</Text>
                ...
                <Text style={styles.detailbus}>สถานีEV (ศูนย์ประชุม) / SC canteen / GREEN CANTEEN / หอพักโซน A-B-C / สังคมศาสตร์ / ศูนย์กีฬา / สถานีEV (เดินรถทางเดียว) </Text>
            </TouchableOpacity>
