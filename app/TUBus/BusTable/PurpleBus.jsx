...
const PurpleBus = ({ navigation }) => {
    ...
    const images = [{
        ...
        props: {
          source: require('../../media/PurpleBusMap.png')
        }
      }];
  return (
    ...
    <ImageBackground source={require('../../media/background.jpg')} style={styles.container}>
        ...
        <View style={styles.centeredContainer}>
            ...
            >
                                <Text style={styles.topicbus}>{menuItems[3].label}</Text>
                ...
                <Text style={styles.detailbus}>สถานี TU DOME / ประตูเชียงราก 1 / ศูนย์กีฬา / สังคมศาสตร์ / GREEN CANTEEN / หอพักโซน A - B (กลับเส้นทางเดิม) </Text>
            </TouchableOpacity>
