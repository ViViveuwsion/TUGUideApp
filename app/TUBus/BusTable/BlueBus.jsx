...
const BlueBus = ({ navigation }) => {
    ...
    const images = [{
        ...
        props: {
          source: require('../../media/BlueBusMap.png')
        }
      }];
  return (
    ...
    <ImageBackground source={require('../../media/background.jpg')} style={styles.container}>
        ...
        <View style={styles.centeredContainer}>
            ...
            >
                                <Text style={styles.topicbus}>{menuItems[4].label}</Text>
                ...
                <Text style={styles.detailbus}>สถานีEV (ศูนย์ประชุม) / SC canteen / ศึกษาศาสตร์ / วิทยาศาสตร์ / สุขศาสตร์ / รพ.ธรรมศาสตร์ (กลับเส้นทางเดิม) </Text>
            </TouchableOpacity>
