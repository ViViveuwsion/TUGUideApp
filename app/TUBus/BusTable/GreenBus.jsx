...
const GreenBus = ({ navigation }) => {
    ...
    const images = [{
        ...
        props: {
          source: require('../../media/GreenBusMap.png')
        }
      }];
  return (
    ...
    <ImageBackground source={require('../../media/background.jpg')} style={styles.container}>
        ...
        <View style={styles.centeredContainer}>
            ...
            >
                                <Text style={styles.topicbus}>{menuItems[2].label}</Text>
                ...
                <Text style={styles.detailbus}>สถานีEV (ศูนย์ประชุม) / รพ.ธรรมศาสตร์ / สุขศาสตร์ / วิทยาศาสตร์ / GREEN CANTEEN / โดมบริหาร / หอพักโซน A - B (กลับเส้นทางเดิม)</Text>
            </TouchableOpacity>
